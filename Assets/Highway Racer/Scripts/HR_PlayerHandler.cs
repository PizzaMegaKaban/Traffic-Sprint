...
public class HR_PlayerHandler : MonoBehaviour {
    ...
    private int MinimumSpeedToScore {
        get {
            return HR_HighwayRacerProperties.Instance.minimumSpeedForGainScore;
        }
    }
    private int MinimumSpeedToHighSpeed {
        get {
            return HR_HighwayRacerProperties.Instance.minimumSpeedForHighSpeed;
        }
    }

    public int TotalDistanceMoneyMP {
        get {
            return HR_HighwayRacerProperties.Instance.totalDistanceMoneyMP;
        }
    }
    public int TotalNearMissMoneyMP {
        get {
            return HR_HighwayRacerProperties.Instance.totalNearMissMoneyMP;
        }
    }
    public int TotalOverspeedMoneyMP {
        get {
            return HR_HighwayRacerProperties.Instance.totalOverspeedMoneyMP;
        }
    }
    public int TotalOppositeDirectionMP {
        get {
            return HR_HighwayRacerProperties.Instance.totalOppositeDirectionMP;
        }
    }
    ...
    private void CheckNearMiss() {
        ...
        if (Physics.Raycast(CarController.AeroDynamics.COM.position, (-transform.right), out hit, 2f, HR_HighwayRacerProperties.Instance.trafficCarsLayer) && !hit.collider.isTrigger) {
            ...
            if (currentTrafficCarNameLeft != null && speed > HR_HighwayRacerProperties.Instance.minimumSpeedForGainScore) {
        ...
        if (Physics.Raycast(CarController.AeroDynamics.COM.position, (transform.right), out hit, 2f, HR_HighwayRacerProperties.Instance.trafficCarsLayer) && !hit.collider.isTrigger) {
            ...
            if (currentTrafficCarNameRight != null && speed > HR_HighwayRacerProperties.Instance.minimumSpeedForGainScore) {
        ...
        if (Physics.Raycast(CarController.AeroDynamics.COM.position, (transform.forward), out hit, 40f, HR_HighwayRacerProperties.Instance.trafficCarsLayer) && !hit.collider.isTrigger) {
            ...
            if (CarController.Lights && CarController.Lights.highBeamHeadlights)
                hit.transform.SendMessage("ChangeLines", SendMessageOptions.DontRequireReceiver);
    ...
    private void OnCollisionEnter(Collision col) {
        ...
        if (impulse < HR_HighwayRacerProperties.Instance.minimumCollisionForGameOver)
            return;
