...
public class RCCP_TruckTrailer : RCCP_GenericComponent {
    ...
    //public float wheelRPMDifference = 0f;
    ...
    private void WheelAlign() {
        ...
        //wheelRPMDifference = trailerWheels[4].wheelCollider.rpm - trailerWheels[5].wheelCollider.rpm;
        ...
        for (int i = 0; i < trailerWheels.Length; i++) {
            ...
            //    trailerWheels[i].wheelCollider.steerAngle += hit.sidewaysSlip * 2f;
            //    trailerWheels[i].wheelCollider.steerAngle = Mathf.Clamp(trailerWheels[i].wheelCollider.steerAngle, -50f, 50f);
