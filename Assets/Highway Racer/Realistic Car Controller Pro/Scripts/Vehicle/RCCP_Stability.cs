...
public class RCCP_Stability : RCCP_Component {
    ...
    /// </summary>
    [Range(0f, 1f)] public float steerHelperStrength = .2f;

    /// <summary>
    /// Traction helper strength.
    /// </summary>
    [Range(0f, 1f)] public float tractionHelperStrength = .2f;

    /// <summary>
    /// Angular drag helper strength.
    /// </summary>
    [Range(0f, 1f)] public float angularDragHelperStrength = .2f;
    ...
    private void SteerHelper() {
        ...
        localVelocity.x *= (1f - (correctedSteerHelper * .1f));
        ...
        CarController.Rigid.AddForce(transform.right * correctedSteerHelper * (CarController.steerAngle / 40f) * Mathf.InverseLerp(10f, 60f, CarController.absoluteSpeed) * 2f, ForceMode.VelocityChange);
        ...
        angularVelocity.y *= (1f - (correctedSteerHelper * .5f));
